...
contract TestGasPriceFeesHook is Test, Deployers {
    ...
    function test_feeUpdatesWithGasPrice() public {
        ...
        uint128 movingAverageGasPrice = hook.s_movingAverageGasPrice();
        uint104 movingAverageGasPriceCount = hook
        ...
        movingAverageGasPrice = hook.s_movingAverageGasPrice();
        movingAverageGasPriceCount = hook.s_movingAverageGasPriceCount();
        assertEq(movingAverageGasPrice, 10 gwei);
